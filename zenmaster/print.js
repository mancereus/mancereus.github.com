...
var t = document.querySelector('#tmpl');
		t.cards = [];
		t.cards = t.cards.concat(dataform.cards);
		t.cards = t.cards.concat(datainhalt.cards);
		t.cards = t.cards.concat(dataort.cards);
		t.cards = t.cards.concat(dataextra.cards);